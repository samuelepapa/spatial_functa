...
@jax.jit
def psnr(image: jnp.ndarray, ground_truth: jnp.ndarray) -> jnp.ndarray:
    ...
    return -10 * jnp.log10(jnp.mean((image - ground_truth) ** 2, axis=(-1, -2, -3)))
